...
/* package sparse-lin-alg-0.4.3 */
#define VERSION_sparse_lin_alg "0.4.3"
#define MIN_VERSION_sparse_lin_alg(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  4 || \
...
#define CURRENT_PACKAGE_KEY "adven_JTVmmEneQ5X7bNJdNEmvZH"
